...
#pragma comment( lib, "Motor3D/PhysFS/libx86/physfs.lib" )
...
bool FileSystem::Init()
{
	...
	// Add all paths in configuration in order - load from config.xml
	...
	char* write_path = SDL_GetPrefPath("Asierigle&Carcasanchez.co", "Asiergine");
