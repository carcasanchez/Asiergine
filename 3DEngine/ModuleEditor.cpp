...
bool ModuleEditor::Start()
{
	...
	style.Colors[ImGuiCol_TitleBgActive] = ImVec4(0.23f, 0.49f, 0.51f, 0.87f);
	...
	style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.88f, 0.33f, 0.08f, 1.00f);
	style.Colors[ImGuiCol_Header] = ImVec4(0.00f, 0.00f, 0.98f, 0.45f);
	style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.21f, 0.21f, 0.60f, 0.80f);
